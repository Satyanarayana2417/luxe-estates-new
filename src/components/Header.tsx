      ...
      <header className={`fixed top-0 left-0 right-0 z-50 glass border-b ${getHeaderBgClass()}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
            ...
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-premium-gradient rounded-xl flex items-center justify-center shadow-lg">
                <Home className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
              </div>
              <div className="flex flex-col">
                <h1 className={`text-lg sm:text-xl ${logoTextClass} drop-shadow-lg`}>LuxeEstates</h1>
                <p className={`text-xs ${subtitleTextClass} hidden sm:block drop-shadow-md`}>Premium Properties</p>
              </div>
            </div>
